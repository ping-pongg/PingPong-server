...
import pingpong.backend.domain.notion.dto.request.NotionConnectDatabaseRequest;
import pingpong.backend.domain.notion.dto.request.NotionOAuthExchangeRequest;
...
public class NotionOauthController {
    ...
    public SuccessResponse<Void> setPrimaryDatabase(
        ...
        notionFacade.setPrimaryDatabase(teamId, member, request.databaseId());
        return SuccessResponse.ok(null);
    }
}
